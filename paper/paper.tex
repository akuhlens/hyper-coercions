  ...
  \item The inductive case proceeds by case analysis on well-typed
    ...
    \begin{itemize}
      ...
      \item For each make hyper-coercion call we show that the a
        ...
        Additionally via Lemma~\ref{lem:mk_hc_depth} and
        Lemma~\ref{lem:mk_hc_wt}, the result
        of the make hyper-coercion call is a candidate for
      ...
      \item Using the information from the calls to the inductive
